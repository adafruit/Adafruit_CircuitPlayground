...
/*!
  ...
  @param   t  Pixel type -- add together NEO_* constants defined in
              ...
              pixel.
*/
Adafruit_CPlay_NeoPixel::Adafruit_CPlay_NeoPixel(uint16_t n, uint16_t p,
                                                 neoPixelType t)
...
/*!
  @brief   Deallocate Adafruit_CPlay_NeoPixel object, set data pin back to
  INPUT.
*/
Adafruit_CPlay_NeoPixel::~Adafruit_CPlay_NeoPixel() {
  free(pixels);
...
*/
void Adafruit_CPlay_NeoPixel::setPixelColor(uint16_t n, uint8_t r, uint8_t g,
                                            uint8_t b) {
...
*/
uint32_t Adafruit_CPlay_NeoPixel::ColorHSV(uint16_t hue, uint8_t sat,
                                           uint8_t val) {
...
*/
void Adafruit_CPlay_NeoPixel::clear(void) { memset(pixels, 0, numBytes); }
