...
void initializeSAMD21PWM(uint16_t khz) {
  ...
  // Connect the TCC timer to the port outputs - port pins are paired odd PMUXO
  // and even PMUXE F & E peripherals specify the timers: TCC0, TCC1 and TCC2
  ...
  IR_TCCx->CC[(IR_CCn & 0x03)].reg =
      cc / 3; // Set the duty cycle of the PWM on TCC0 to 33%
