 ...
 * The firmware version will not always equal the protocol version going
 * forward. Query using the REPORT_FIRMWARE message.
 */
#define FIRMATA_FIRMWARE_MAJOR_VERSION 2
#define FIRMATA_FIRMWARE_MINOR_VERSION 5
#define FIRMATA_FIRMWARE_BUGFIX_VERSION 3

/* DEPRECATED as of Firmata v2.5.1. As of 2.5.1 there are separate version
 * numbers for the protocol version and the firmware version.
 */
...
#define SCHEDULER_DATA                                                         \
  0x7B // send a createtask/deletetask/addtotask/schedule/querytasks/querytask
